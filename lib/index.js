...
;(function (WechatLogin) {
    ...
    /**
     * get website qrcode login url
     */
    WechatLogin.prototype.loginUrl = function (scope) {
        let redirectUrl = 'https://open.weixin.qq.com/connect/qrconnect?appid='
            + this.APP_ID + '&redirect_uri=' + this.REDIRECT_URI + '&response_type=code&scope=' + scope + '&state=' + new Date().getTime() + '#wechat_redirect';
        return redirectUrl;
    };

    /**
     * get website authorize url
     */

    WechatLogin.prototype.authorizeUrl = function (scope) {
     ...
     */
    WechatLogin.prototype.login = function (req, res, scope) {
        res.redirect(this.loginUrl(scope));
    };

    /**
     * wechat authorize directly（without scan qrcode）
     */
    WechatLogin.prototype.authorize = function (req, res, scope) {
        res.redirect(this.authorizeUrl(scope));
    };
    ...
    // this.SCOPE_WEB_LOGIN = 'snsapi_userinfo';
});