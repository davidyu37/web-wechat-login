...
;(function (WechatLogin) {
     ...
     */
    WechatLogin.prototype.loginUrl = function () {
        let redirectUrl = 'https://open.weixin.qq.com/connect/qrconnect?appid='
            + this.APP_ID + '&redirect_uri=' + this.REDIRECT_URI + '&response_type=code&scope=' + this.SCOPE_WEB_LOGIN + '&state=' + new Date().getTime() + '#wechat_redirect';
        return redirectUrl;
    };
    ...
    WechatLogin.prototype.authorizeUrl = function () {
     ...
     */
    WechatLogin.prototype.authorize = function (req, res) {
